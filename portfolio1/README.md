...
| # | 질문 |
|---|---|
| 1 | 서울에서 **성장하는 상권**은 어디인가? |
| 2 | **매출 성장과 유동인구 변화**는 어떤 관계가 있는가? |
| 3 | **최근 떠오르는 상권 (Hot Area)** 은 어디인가? |
| 4 | **시간대 · 성별 · 요일**에 따라 소비 패턴은 어떻게 다른가? |
...
서울 열린데이터광장에서 제공하는  
**서울시 우리마을가게 상권분석서비스 데이터**를 활용했습니다.
